...
/**
 * Adaptateur pour afficher la liste des comptes dans un RecyclerView
 */
public class CompteAdapter extends RecyclerView.Adapter<CompteAdapter.CompteViewHolder> {

    /**
     * Interface pour gérer les clics sur le bouton Supprimer
     */
    ...
    /**
     * Interface pour gérer les clics sur le bouton Modifier
     */
     ...
     * 
     * @param onDeleteClickListener Listener pour la suppression
     * @param onUpdateClickListener Listener pour la modification
     */
    ...
    /**
     * ViewHolder pour gérer les vues de chaque élément
     */
    class CompteViewHolder extends RecyclerView.ViewHolder {
        ...
        /**
         * Lie les données d'un compte aux vues
         * 
         * @param compte Compte à afficher
         */
